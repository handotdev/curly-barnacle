...
times.forEach((time) => {
    functions.insertData(collectionsRef, "W "+time+"AM", 'ag759@cornell.edu', toAdd.data).then((res) => {
        console.log("Successfully add doc for ag759@cornell.edu at "+time);
    });
    functions.insertData(collectionsRef, "W "+time+"AM", 'hyw2@cornell.edu', toAdd.data).then((res) => {
