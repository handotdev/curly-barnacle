...
function Window() {
  ...
  <div className="row">
    ...
    <div className="column middle">
      <input className="domain" type="text" value="https://www.gmail.com" readOnly />
    </div>
  </div>
  ...
  <div className="content" style={{textAlign: 'center'}}>
    ...
    <p>Zoom Link: 
        <a href="https://cornell.zoom.us/j/710144471?pwd=YjlNQVlJbURoeG"> https://cornell.zoom.us/j/710144471?pwd=YjlNQVlJbURoeG</a>
    </p>
  </div>
</div>
    )
